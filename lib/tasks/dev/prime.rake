if Rails.env.development? || Rails.env.test?
  ...
  namespace :dev do
    ...
    task prime: 'db:setup' do #dependence 
      ...
      15.times do
        coupom_status = [:active, :inactive].sample
        create(:coupon, status: coupom_status)
      end
      ...
      30.times do
        ...
        game_categories_ids = []
        rand(0..3).times { game_categories_ids << Category.all.sample.id}
